...
if(isset($_POST['update_post'])) {
                ...
                $post_category_id = escape($_POST['post_category']);  // !!!!!!!added _id
    ...
    //$post_title = mysqli_real_escape_string($connection, $post_title);     MOC
    //$post_content = mysqli_real_escape_string($connection, $post_content);    MOC
...
<?php echo "<option value='{$post_user}'>{$post_user}</option>"; ?>
    ...
    $post_content = htmlspecialchars(stripslashes($post_content));  //MOC
